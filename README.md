...
| 5. Approval gate | You see every comment verbatim and the verdict, then pick from a clickable menu: approve as recommended / approve with no nits / comment only / chat about it. REQUEST_CHANGES and re-reviews get their own options, and re-reviews add "report only". Nothing is posted yet. |
